        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                $data.queueItem = $('<div class="uploadifive-queue-item">\
                    ...
                    <div class="progress">\
                        <div class="progress-bar uploadifive-progress-bar progress progress-sucess"><div class="bar"></div></div>\
                    </div>\
                </div>');
                ...
                $data.removeQueueItem = function(file, instant, delay) {
                    ...
                    if (file.queueItem) {
                        ...
                        file.queueItem.find('.progress-bar .bar').width(0);
                ...
                $data.progress = function(e, file) {
                    if ($.inArray('onProgress', settings.overrideEvents) < 0) {
                        ...
                        file.queueItem.find('.progress-bar .bar').css('width', percent + '%');
                    }
                ...
                $data.uploadComplete = function(e, file, uploadAll) {
                    if ($.inArray('onUploadComplete', settings.overrideEvents) < 0) {
                        file.queueItem.find('.progress-bar .bar').css('width', '100%');
